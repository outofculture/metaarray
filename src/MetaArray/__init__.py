...
MetaArray is an array class based on numpy.ndarray that allows storage of per-axis metadata
...
class MetaArray(object):
    ...
    wrapMethods = {"__eq__", "__ne__", "__le__", "__lt__", "__ge__", "__gt__"}
    ...
    def rowsort(self, axis, key=0):
        ...
        if type(axis) == int:
            ...
            raise TypeError("axis must be of type int or string")
    ...
    def _readHDF5Remote(self, fileName):
        ...
        if proc is None:
            ...
            MetaArray._h5py_metaarray = proc._import("MetaArray")
